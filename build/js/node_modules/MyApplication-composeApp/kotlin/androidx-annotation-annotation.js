(function (factory) {
  ...
  var contentEquals_0 = kotlin_kotlin.$_$.v7;
  ...
  initMetadataForClass(EmptySuper, 'EmptySuper', VOID, VOID, [Annotation]);
  ...
  initMetadataForClass(StringDef, 'StringDef', VOID, VOID, [Annotation]);
  ...
  protoOf(EmptySuper).equals = function (other) {
    if (!(other instanceof EmptySuper))
      return false;
    other instanceof EmptySuper || THROW_CCE();
    return true;
  };
  protoOf(EmptySuper).hashCode = function () {
    return 0;
  };
  protoOf(EmptySuper).toString = function () {
    return '@androidx.annotation.EmptySuper(' + ')';
  };
  ...
  function StringDef(value, open) {
    value = value === VOID ? [] : value;
    open = open === VOID ? false : open;
    this.value_1 = value;
    this.open_1 = open;
  }
  protoOf(StringDef).get_value_j01efc_k$ = function () {
    return this.value_1;
  };
  protoOf(StringDef).get_open_worwk3_k$ = function () {
    return this.open_1;
  };
  protoOf(StringDef).equals = function (other) {
    if (!(other instanceof StringDef))
      return false;
    var tmp0_other_with_cast = other instanceof StringDef ? other : THROW_CCE();
  ...
  protoOf(StringDef).hashCode = function () {
    var result = imul(getStringHashCode('value'), 127) ^ hashCode(this.value_1);
    result = result + (imul(getStringHashCode('open'), 127) ^ getBooleanHashCode(this.open_1)) | 0;
    return result;
  };
  protoOf(StringDef).toString = function () {
    return '@androidx.annotation.StringDef(' + 'value=' + toString(this.value_1) + ', ' + 'open=' + this.open_1 + ')';
  };
  function Companion() {
