...
export async function instantiate(imports={}, runInitializer=true) {
    ...
    const wasmFilePath = './MyApplication-composeApp.wasm';
    ...
    try {
      ...
      if (isBrowser) {
        wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./MyApplication-composeApp.wasm',import.meta.url).href), importObject, { builtins: [''] })).instance;
      }
    } catch (e) {
